...
| **Итого (RPS пик)**  | **25 164** | **7 495**            | **7 495**            | **7 495**            | **6 347**            |
...
|----------------------|---------|----|
| Лента постов         | 620     |пост, профиль и подписка|
| Чтение постов        | 9 300   |пост, профиль и подписка|
| Написание постов     | 2       |пост, профиль и сессия|
| Коментарии           | 16      |профиль, коментарии и сессия|
| Коментарии(чтение)   | 4 150   |профиль, коментарии|
...
**чтение**
- пост 620 + 9300 + 2 + 165 = 10 087
- профиль 620 + 9 300 + 2 + 16 + 4 150 + 0.002 + 1.2 = 14 102
- сессия 2 + 16 + 1.2 = 19.2
- комментарии 4 150
- рекомендации 10 900
- метрика поиска 10 900
- метрика просмотра 10 900
- подписка 620 + 9 + 300 + 10 + 900 = 1 839
