...
| Технология / Библиотека | Область применения | Мотивационная часть (преимущества, обоснование выбора) |
|--------------------------|--------------------|--------------------------------------------------------|
| **Go (Golang)** | Backend | Высокая производительность, статическая типизация, простота развёртывания (один бинарник)|
...
| **Nginx (внешний)** | Прокси | Высокая производительность, надёжность, SSL |
| **Git** | Разработка | Стандарт в индустрии для совместной разработки |
