...
|Коментарии(чтение)|2400|7200|57,6 мб/c|1,63 тб|
|Рекомендации|6 300|19 000|38 гб/c|1,1 Пб|
|Регистрация|0,001|0,003|0,005 кб/c|0,0015кб/c|
|Подписка|0,7|2,1|1,4 кб/c|4,1 кб/c|
|Монетизация|-|-|-|-|
...
- Пост
  - 8 кб текст поста
  - В посте в среднем 5-6 картинок по 340 кб = 2мб картинок на пост + 8 кб поста= 2,02мб
...
- Коментарии (чтение)
  ...
  - 2 400 * 3 = 7 200 RPS в пике => 7200 * 8кб = 57,6 мб/c
- Подписка
  - Пусть вес запроса будет 2кб
  - (0,002 подписок в день * 31 000 000 DAU) / 86 400 = 0,7 RPS => 0,7 RPS * 2кб = 1,4 кб/c
  - 0,7 RPS * 3 = 2,1 RPS => 2,1 * 2 = 4,1 кб/c
  - 0,7 RPS * 86 400 с * 2кб = 121 мб
- Регистрация
  ...
  - 0,001 RPS * 3 = 0,003 RPS => 0,003 * 5 = 0,015 кб/c
  - 0,00009 * 31 000 000 * 5 = 14мб
...
Выбраны 4 дц что бы захватывать большую часть городов от 500тыс
<img width="1111" height="578" alt="ДЦ Дзен" src="https://github.com/user-attachments/assets/3ecea877-d6da-4b61-9823-63ba6e64afa7" />
Города так же выбраны на основе магистралей - наибольшие выходы именно из этих городов
