...
<img width="1383" height="1175" alt="image" src="https://github.com/user-attachments/assets/3bcaa842-7a0d-4298-a953-bafcdb41522c" />
...
**Индексы**
- пост
  - author_id - показать посты автора
    - вес индекса 8 * 10 000 000 (предположительная оценка количества авторов) = 80 мб
- сессия
  - не требуется из-за redis
- комментарии
  - post_id, created_at - показывать в постах (будут отсортированны по дате создани что бы каждый раз был одинаковый порядок)
    - вес индекса 16 * 2 000 000 000 = 32 гб
  - id, parent_id, created_at - показывать ответы на комменатрий
    - вес индекса 24 * 2 000 000 000 = 48 гб
- рекомендации
  - author_id - для рекомендаций конкретного пользователя
    - вес индекса 8 * 100 000 000 = 800 мб
- подписка
  - author_id, subscriber_id - для подписок на автора
    - вес индекса 16 * 68 000 000 = 1,1 гб
...
- session: 272 * (79 000 000 * 0,6 * 1,1) = 272 * 52 100 000 = 304,4 гб
- profile: 698 * 100 000 000 = 68,9 Гб
- view_metrics: 56 * 15 * 31 000 000 * 30 = 56 * 13 900 000 000 = 781 гб
- recommendation: ...
- search_metrics: 272 * 0,27 * 31 000 000 * 30 = 272 * 251 000 000 = 68,3 гб
- subscription: 24 * 0,002 * 31 000 000 * 365 * 3 = 24 *  67 900 000 = 1,7 гб 
...
|----------------------------|------------------------|----------------|
| profile                    |                        | 3 реплики       | 
| subscription               |                        | 5 реплик        |
| session                    | 2 шарда по id mod 2    | 1 реплика       | 
| post                       |                        | 3 реплики       |
| search_post                | 2 шарда по id mod 2    | 1 реплика       | 
| comment                    |                        | 2 реплики       |
| photo                      | 10 шардов              | 2 реплики       |
| view_metric                | 2 шарда по user_id mod 2 | 1 реплика     |
