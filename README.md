...
**Индексы**
- пост
  - id - стандартный индекс для поиска определённого поста
...
- subscription: 24 * 5 000 000 * 12 * 5 = 24 * 300 000 000 = 7,2 гб 
...
Индексы comment веся 16 + 32 + 48 = 96 гб. Индекс не влезает в стандартный под оперативной памяти.
