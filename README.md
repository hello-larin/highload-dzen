...
282 / 15 = 18,8 ~= 19. Для запа берём ещё 6 итого 25 дисков
...
Сервер xFusion 1288H V7 8SFF - для БД и сервисов (1 828 200р)
...
2000 ядер для БД и минио + 33 ядра для БД = 2 033

2 033 / 64 ~= 32 сервера + 3 в запасе

35 * 1 828 200 = 64 млн рублей

итого 8,6 + 1 + 64 = 73,6 млн рублей
