...
На 1 ядро - 100 rps для простой логики. Для сложной 20 rps

| Действие             | RPS пик | CPU |
|----------------------|---------|-----|
| Лента постов         | 620     | 10  |
| Чтение постов        | 9 300   | 100 |
| Написание постов     | 2       | 1   |
| Коментарии           | 16      | 1   |
| Коментарии(чтение)   | 4 150   | 45  |
| Рекомендации         | 10 900  | 545 |
| Регистрация          | 0.002   | 1   |
| Подписка             | 1.2     | 1   |
| Поиск                | 165     | 15  |
| Авторизация          | 6       | 1   |
...
Для основной БД порядка 4 ТБ, а для MINIO 250 ТБ.
