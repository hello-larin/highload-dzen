...
- пост
  ...
  - status - для быстрого отсеивания удалённых постов btree
    - вес индекса 8 * 122 000 000 = 1 гб
- сессия
...
- комментарии
  ...
  - status - для быстрой фильтрации удалённых комментариев btree
    - вес индекса 8 * 2 000 000 000 = 16 гб
- подписка
  - id - стандартный индекс btree
...
- поиск
  ...
  - status - что бы не показывались удалённые посты btree
    - вес индекса 8 * 122 000 000 = 1 гб
- выплаты
  - id - стандартный индекс btree
...
- профиль
  ...
  - status - что бы не показывать забаненного пользователя btree
...
| **Kafka**                | БД                 | Брокер сообщений с гарантиями доставки и рассчитанный на большие нагрузки |
